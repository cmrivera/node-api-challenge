...
We learned how to use express routers to route our pages and request information and data. we also learned how to create server with express

- [ ] Describe Middleware?

Middleware are functions created that have access to request and response objects. (req,res) It also has access to the next function to continue with the apps lifecycle

- [ ] Describe a Resource?

* [ ] What can the API return to help clients know if a request was successful?

the api can return a 200 message stating the request was successful

- [ ] How can we partition our application into sub-applications?

we can partition our app into sub apps by using routers to seperate into smaller manageable files.
